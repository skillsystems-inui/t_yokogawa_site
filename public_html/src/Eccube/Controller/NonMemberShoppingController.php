...
class NonMemberShoppingController extends AbstractShoppingController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //会員名・カナ・住所の全てデータ
            $_name_all = $data['name01'].' '.$data['name02'];
            $_kana_all = $data['kana01'].' '.$data['kana02'];
            $_addr_all = $data['addr01'].' '.$data['addr02'];
            ...
            $Customer
                ...
                ->setNameAll($_name_all)
                ->setKanaAll($_kana_all)
                ->setAddrAll($_addr_all)
                ;
    ...
    public function customer(Request $request)
    {
        ...
        try {
            ...
            //[注文情報]会員名・カナ・住所の全てデータ
            $_order_name_all = $data['customer_name01'].' '.$data['customer_name02'];
            $_order_kana_all = $data['customer_kana01'].' '.$data['customer_kana02'];
            $_order_addr_all = $data['customer_addr01'].' '.$data['customer_addr02'];
            ...
            $Order
                ...
                ->setNameAll($_order_name_all)
                ->setKanaAll($_order_kana_all)
                ->setAddrAll($_order_addr_all)
                ;

            $this->entityManager->flush();

            //[会員情報]会員名・カナ・住所の全てデータ
            $_cus_name_all = $data['customer_name01'].' '.$data['customer_name02'];
            $_cus_kana_all = $data['customer_kana01'].' '.$data['customer_kana02'];
            $_cus_addr_all = $data['customer_addr01'].' '.$data['customer_addr02'];
            ...
            $Customer
                ...
                ->setAddr02($data['customer_addr02'])
                ->setEmail($data['customer_email'])
                ->setNameAll($_cus_name_all)
                ->setKanaAll($_cus_kana_all)
                ->setAddrAll($_cus_addr_all)
                ;
