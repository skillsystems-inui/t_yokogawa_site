...
if (!class_exists('\Eccube\Entity\ProductSmartCategory')) {
    /**
     * ProductSmartCategory
     *
     * @ORM\Table(name="dtb_product_smart_category")
     * @ORM\InheritanceType("SINGLE_TABLE")
     * @ORM\DiscriminatorColumn(name="discriminator_type", type="string", length=255)
     * @ORM\HasLifecycleCallbacks()
     * @ORM\Entity(repositoryClass="Eccube\Repository\ProductSmartCategoryRepository")
     */
    class ProductSmartCategory extends \Eccube\Entity\AbstractEntity
    {
        /**
         * @var int
         *
