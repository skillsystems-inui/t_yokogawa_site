...
if (!class_exists('\Eccube\Entity\Shipping')) {
    ...
    class Shipping extends \Eccube\Entity\AbstractEntity
    {
        ...
        {
            //名前(全)セット
            $_NameAll = $CustomerAddress->getName01().' '.$CustomerAddress->getName02();
            $_KanaAll = $CustomerAddress->getKana01().' '.$CustomerAddress->getKana02();
            $_AddrAll = $CustomerAddress->getAddr01().' '.$CustomerAddress->getAddr02();
         ...
         * Set kana_all.
         *
         * @param string $kana_all
         *
         * @return Shipping
         */
        public function setKanaAll($kana_all)
        {
