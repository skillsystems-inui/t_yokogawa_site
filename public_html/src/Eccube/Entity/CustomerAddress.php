...
if (!class_exists('\Eccube\Entity\CustomerAddress')) {
    ...
    class CustomerAddress extends AbstractEntity
    {
        ...
        {
            //名前(全)セット
            $_NameAll = $Shipping->getName01().' '.$Shipping->getName02();
            $_KanaAll = $Shipping->getKana01().' '.$Shipping->getKana02();
            $_AddrAll = $Shipping->getAddr01().' '.$Shipping->getAddr02();
         ...
         * Set name_all.
         *
         * @param string|null $name_all
         *
         * @return CustomerAddress
         */
        public function setNameAll($name_all = null)
        {
